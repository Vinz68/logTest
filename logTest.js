...
const APPNAME = 'logTest';                  // Name of this app used here and there
const PORT = 8080;                          // Node will listen on port number...
const HOSTNAME = 'localhost'                // our hostname


// HTML Request custom log function (show relevant request attributes only)
...
var log = bunyan.createLogger({
	...
	serializers: {
        //req: reqSerializer               // use my own HTTP server request serializer
...
var server = app.listen(PORT, function () {
    ...
    log.info(APPNAME + ' is ready and listening on port:' + server.address().port);
});
